...
class TestFamilyValidation(unittest.TestCase):
    ...
    def test_check_same_name_valid(self):
        print('US25: Testing family with all children having a unique name (valid)')
        ...
        errors = FamilyValidation.check_same_name(validParsedFile, errors)

        self.assertEqual(len(errors), 0, msg='Failed to check valid family for multiple children with the same name')

    def test_check_same_name_invalid(self):
        print('US25: Testing family with > 1 child having the same name (invalid)')

        invalidParsedFile = {'family': {'@F6000000089090979889@': {'Children': {'@I6000000089090979883@', '@I6000000089090979871@', 
                        '@I6000000089090979874@', '@I6000000089090979891@', '@I6000000089090979877@', '@I6000000089090979880@'}, 
                        'Married': '4 JUL 1990', 'Spouse 1': '@I6000000089090867827@', 'Spouse 2': '@I6000000089090979886@', 
                        'Spouse 1 Name': 'Brian', 'Spouse 2 Name': 'Jane Lancing /Smith/', 'Divorced': 'NA'}}, 
                        'members': {'@I6000000089090867827@': {'ID': '@I6000000089090867827@', 'Child': 'NA', 
        ...
        errors = FamilyValidation.check_same_name(invalidParsedFile, errors)

        self.assertEqual(len(errors), 1, msg='Failed to check invalid family for multiple children with the same name')
