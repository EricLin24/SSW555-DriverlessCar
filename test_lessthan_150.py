...
class TestLessThan150(unittest.TestCase):
    def test_invalid_parameter(self):
        self.assertEqual(less_than_150('testcases')[0], -1, msg='The parameter inputed is invalid, should be a dict')

    def test_alive_less_than_150(self):
        member1 = {'Birthday': '27 DEC 1930', 'Death':'NA'}
        member2 = {'Birthday': '5 MAY 1958', 'Death': 'NA'}
        self.assertEqual(less_than_150(member1)[0], True, msg='Result should be true')
        self.assertEqual(less_than_150(member2)[0], True, msg='Result should be true')
    ...
    def test_alive_more_than_150(self):
        ...
        self.assertEqual(less_than_150(member1)[0], False, msg='Result should be false')
